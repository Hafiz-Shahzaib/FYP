...
function Card({thumbnail, title, semester, courseCode, subject, id, reviews}) {
  ...
  return (
    <div className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-300' onClick={()=>navigate(`/viewcourse/${id}`)}>
      ...
      <div className='p-5 space-y-2'>
        ...
        <span className='px-2 py-0.5 bg-gray-100 rounded-full text-gray-700 capitalize'>{semester}</span>
          
        <span className='px-2 py-0.5 bg-gray-100 rounded-full text-gray-700 capitalize'>Course Code : {courseCode}</span>
