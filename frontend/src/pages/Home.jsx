  ...
  return (
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex items-center justify-center gap-3 flex-wrap'>
        ...
        {/* <button className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black rounded-[10px] text-[18px] font-light flex gap-2 cursor-pointer' onClick={()=>navigate("/chat")}>Chat <SiViaplay className='w-[30px] h-[30px] lg:fill-white fill-black'/></button> */}
