...
function EditLecture() {
    ...
    const [lectureContent, setLectureContent] = useState(selectedLecture?.lectureContent || "")
...
formdata.append("lectureContent", lectureContent)
...
if (typeof videoUrl !== "string") {
 ...
 <div>
    <label className='block text-sm font-medium mb-1'>Lecture Content</label>
    <ReactQuill
